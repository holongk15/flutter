...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // home: const MyHomePage(title: 'Đếm số +++a++ hi'),
      home: Scaffold(
...
body: ListView(
        children: [
          _buildPhoneNumberItem('Anh', '+123456789', Icons.person),
          _buildPhoneNumberItem('Em', '+987654321', Icons.person),
...
Widget _buildPhoneNumberItem(String name, String phoneNumber, IconData iconData) {
  return ListTile(
